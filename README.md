...
| `DATA_DIR` | Generated data root (default `$APP_DATA_DIR/data`) — `YYYY/MM/providers/` (raw archives) + `YYYY/MM/{public,members,stewards}/` (processed, per audience — see docs/audiences.md; consumers: docs/website.md). |
