...
func TestStripePayoutSync(t *testing.T) {
	...
	err = syncStripeToOdoo(acc, creds, uid, 0, false, false, payout1, time.Time{})
	if err != nil {
	...
	err = syncStripeToOdoo(acc, creds, uid, 0, false, false, payout2, time.Time{})
	if err != nil {
	...
	err = syncStripeToOdoo(acc, creds, uid, 0, false, true, payout1, time.Time{})
	if err != nil {
...
func TestStripePayoutSyncDryRun(t *testing.T) {
	...
	err = syncStripeToOdoo(acc, creds, uid, 0, true, false, "po_1OUgT1FAhaWeDyowVcD9E9Hn", time.Time{})
	if err != nil {
